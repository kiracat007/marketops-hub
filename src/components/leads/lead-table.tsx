...
type LeadTableProps = { leads: LeadRecord[]; onEdit: (lead: LeadRecord) => void; onDelete: (lead: LeadRecord) => void; onCreateOpportunity: (lead: LeadRecord) => void };

export function LeadTable({ leads, onEdit, onDelete, onCreateOpportunity }: LeadTableProps) {
  ...
  return <div className="overflow-hidden rounded-[14px] border border-zinc-200/80 bg-white shadow-sm"><div className="overflow-x-auto"><table className="w-full min-w-[1420px] text-left text-sm">
